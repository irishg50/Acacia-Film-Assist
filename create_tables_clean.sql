-- Nomad Chatbot Database Schema - Clean Version
-- PostgreSQL script to create all tables (handles orphaned indexes)

-- First, drop any orphaned indexes that might exist
DROP INDEX IF EXISTS ix_nomadchat_organization_name;
DROP INDEX IF EXISTS ix_nomadchat_organization_domain;
DROP INDEX IF EXISTS ix_nomadchat_users_organization_id;
DROP INDEX IF EXISTS ix_nomadchat_users_username;
DROP INDEX IF EXISTS ix_nomadchat_chatsession_user_id;
DROP INDEX IF EXISTS ix_nomadchat_chatsession_project_id;
DROP INDEX IF EXISTS ix_nomadchat_chatsession_session_id;
DROP INDEX IF EXISTS ix_nomadchat_chatsession_created_at;
DROP INDEX IF EXISTS ix_nomadchat_documents_user_id;
DROP INDEX IF EXISTS ix_nomadchat_documents_project_id;
DROP INDEX IF EXISTS ix_nomadchat_documents_filename;
DROP INDEX IF EXISTS ix_nomadchat_document_chunks_document_id;
DROP INDEX IF EXISTS ix_nomadchat_document_chunks_chunk_number;
DROP INDEX IF EXISTS ix_nomadchat_project_user_id;
DROP INDEX IF EXISTS ix_nomadchat_project_name;
DROP INDEX IF EXISTS ix_nomadchat_api_log_user_id;
DROP INDEX IF EXISTS ix_nomadchat_api_log_timestamp;
DROP INDEX IF EXISTS ix_nomadchat_login_record_user_id;
DROP INDEX IF EXISTS ix_nomadchat_login_record_login_time;
...
CREATE INDEX ix_nomadchat_organization_name ON nomadchat_organization (name);
CREATE INDEX ix_nomadchat_organization_domain ON nomadchat_organization (domain);
...
CREATE INDEX ix_nomadchat_users_organization_id ON nomadchat_users (organization_id);
CREATE INDEX ix_nomadchat_users_username ON nomadchat_users (username);
...
CREATE INDEX ix_nomadchat_chatsession_user_id ON nomadchat_chatsession (user_id);
CREATE INDEX ix_nomadchat_chatsession_project_id ON nomadchat_chatsession (project_id);
CREATE INDEX ix_nomadchat_chatsession_session_id ON nomadchat_chatsession (session_id);
CREATE INDEX ix_nomadchat_chatsession_created_at ON nomadchat_chatsession (created_at);

CREATE INDEX ix_nomadchat_documents_user_id ON nomadchat_documents (user_id);
CREATE INDEX ix_nomadchat_documents_project_id ON nomadchat_documents (project_id);
CREATE INDEX ix_nomadchat_documents_filename ON nomadchat_documents (filename);

CREATE INDEX ix_nomadchat_document_chunks_document_id ON nomadchat_document_chunks (document_id);
CREATE INDEX ix_nomadchat_document_chunks_chunk_number ON nomadchat_document_chunks (chunk_number);

CREATE INDEX ix_nomadchat_project_user_id ON nomadchat_project (user_id);
CREATE INDEX ix_nomadchat_project_name ON nomadchat_project (name);

CREATE INDEX ix_nomadchat_api_log_user_id ON nomadchat_api_log (user_id);
CREATE INDEX ix_nomadchat_api_log_timestamp ON nomadchat_api_log (timestamp);

CREATE INDEX ix_nomadchat_login_record_user_id ON nomadchat_login_record (user_id);
CREATE INDEX ix_nomadchat_login_record_login_time ON nomadchat_login_record (login_time);
...
AND table_name LIKE 'nomadchat_%'
ORDER BY table_name;
